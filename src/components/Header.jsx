  ...
  return (
    <div className="flex flex-col sm:flex-row w-full h-auto bg-gradient-to-b from-[#121110] to-[#1B1A19] p-8 sm:p-14 items-center border-b-[0.10px] border-white border-opacity-2">
      ...
      <motion.div className="flex flex-col sm:pr-10 selection:bg-orange-500 selection:text-white"
        ...
        <p className="text-md sm:text-2xl p-2 text-white sm:text-left text-center">a Passionate Full Stack Web Developer Crafting Beautiful & Functional Websites. I'm looking for opportunities to collaborate, learn, and grow in the tech industry. Excited to connect and explore job opportunities in web development!</p>
      </motion.div>
